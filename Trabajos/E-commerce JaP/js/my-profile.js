    ...
    <div class="container mt-4"> 
        <form id="form" action="#" method="get">
            <div class="d-flex justify-content-between">
                ...
                <img id="img-profile" src=${datosProfile.image === undefined || datosProfile.image === "" ? "https://www.softzone.es/app/uploads/2018/04/guest.png" : `"${datosProfile.image}"`} class="img-thumbnail" style="width:130px; height:auto;" alt="image-profile">
            </div>
            <hr>
